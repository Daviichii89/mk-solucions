  ...
  return (
    <section id="Home" className={styles.home}>
      ...
      <article className={styles.ctaContainer}>
        ...
        <a
          href='https://wa.me/622845258'
          target="_blank"    
          style={{ position: 'fixed', display: 'flex', justifyContent:'center', alignItems: 'center', bottom: '20px', right: '20px', zIndex: 3, backgroundColor: 'green', color: 'white', padding: '20px', borderRadius: '100%', width: '60px', height: '60px'}}
        >
          <div>
            <svg style={{ pointerEvents:"none", display:"block", height:"60px", width:"60px"}} viewBox="0 0 1219.547 1225.016">
        ...
        <div style={{width: '10px'}}>
          <a
            href='tel:+34622845258'
            target="_blank"
            style={{ position: 'fixed', display: 'flex', justifyContent:'center', alignItems: 'center', bottom: '20px', left: '20px', zIndex: 3, backgroundColor: 'blue', color: 'white', padding: '20px', border: '4px solid white', borderRadius: '100%', width: '60px', height: '60px'}}
